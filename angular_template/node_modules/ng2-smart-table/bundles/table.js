/**
  ...
  * License: MIT
  */
import { Component, ComponentFactoryResolver, ElementRef, EventEmitter, Input, NgModule, Output, ViewChild, ViewContainerRef } from '@angular/core';
...
class ServerDataSource extends LocalDataSource {
    ...
    addSortRequestOptions(requestOptions) {
        const searchParams = requestOptions.search;
        if (this.sortConf) {
            this.sortConf.forEach((fieldConf) => {
