(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@angular/animations'), require('rxjs/Observable'), require('rxjs/add/operator/share'), require('rxjs/Subject'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', '@angular/animations', 'rxjs/Observable', 'rxjs/add/operator/share', 'rxjs/Subject', '@angular/common'], factory) :
	(factory((global.angular2toaster = global.angular2toaster || {}),global.ng.core,global._angular_platformBrowser,global._angular_animations,global.Rx,global.Rx,global.Rx,global.ng.common));
}(this, (function (exports,_angular_core,_angular_platformBrowser,_angular_animations,rxjs_Observable,rxjs_add_operator_share,rxjs_Subject,_angular_common) { 'use strict';
